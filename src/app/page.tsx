        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 sm:pt-20 sm:pb-24">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-500">
              Find compassionate mental health providers and create personalized care plans
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="text-center">
              ...
              <p className="mt-2 text-base text-gray-500">
                Search our directory of mental health professionals who understand ministry challenges
              </p>
            </div>
        ...
        <div className="bg-blue-600 mt-16">
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
              <span className="block">Ready to prioritize your mental health?</span>
